...
class Tabela extends AbstractStructBase
{
     ...
     * @uses Tabela::setNrLocal()
     * @uses Tabela::setHoraLocal()
     * @uses Tabela::setNrCentral()
     * @uses Tabela::setHoraCentral()
     * @uses Tabela::setVersaoTabela()
     * @uses Tabela::setVersaoInterface()
     * @uses Tabela::setSeuSistema()
     * @uses Tabela::setSessao()
     * @uses Tabela::setCtlAP()
     * @param int $nrLocal
     ...
     * Set NrLocal value
     * @param int $nrLocal
     * @return \App\Http\AreasNegocio\CAD\WSDL\StructType\Tabela
     */
