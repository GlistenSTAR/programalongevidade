 ...
 * @subpackage Structs
 */
class BaseWebServiceReturnCadastroPF extends AbstractStructBase
{
    /**
     * The StatusServico
     ...
     * @uses BaseWebServiceReturnCadastroPF::setStatusServico()
     * @uses BaseWebServiceReturnCadastroPF::setNrLocal()
     * @uses BaseWebServiceReturnCadastroPF::setHoraLocal()
     * @uses BaseWebServiceReturnCadastroPF::setHoraCentral()
     * @uses BaseWebServiceReturnCadastroPF::setNrCentral()
     * @uses BaseWebServiceReturnCadastroPF::setRetCode()
     * @uses BaseWebServiceReturnCadastroPF::setTextoInformativo()
     * @uses BaseWebServiceReturnCadastroPF::setSeuSistema()
     * @uses BaseWebServiceReturnCadastroPF::setNrControleLocal()
     * @uses BaseWebServiceReturnCadastroPF::setSessao()
     * @uses BaseWebServiceReturnCadastroPF::setDesvioFluxo()
     * @uses BaseWebServiceReturnCadastroPF::setCtlAP()
     ...
     * @param int $statusServico
     * @return \App\Http\AreasNegocio\CAD\WSDL\StructType\BaseWebServiceReturnCadastroPF
     */
