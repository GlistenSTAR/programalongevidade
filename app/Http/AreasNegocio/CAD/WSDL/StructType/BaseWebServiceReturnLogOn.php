 ...
 * @subpackage Structs
 */
class BaseWebServiceReturnLogOn extends AbstractStructBase
{
    /**
     * The StatusServico
     ...
     * @uses BaseWebServiceReturnLogOn::setStatusServico()
     * @uses BaseWebServiceReturnLogOn::setNrLocal()
     * @uses BaseWebServiceReturnLogOn::setHoraLocal()
     * @uses BaseWebServiceReturnLogOn::setHoraCentral()
     * @uses BaseWebServiceReturnLogOn::setNrCentral()
     * @uses BaseWebServiceReturnLogOn::setRetCode()
     * @uses BaseWebServiceReturnLogOn::setTextoInformativo()
     * @uses BaseWebServiceReturnLogOn::setSeuSistema()
     * @uses BaseWebServiceReturnLogOn::setNrControleLocal()
     * @uses BaseWebServiceReturnLogOn::setSessao()
     * @uses BaseWebServiceReturnLogOn::setDesvioFluxo()
     * @uses BaseWebServiceReturnLogOn::setCtlAP()
     ...
     * @param int $statusServico
     * @return \App\Http\AreasNegocio\CAD\WSDL\StructType\BaseWebServiceReturnLogOn
     */
