 ...
 * @subpackage Structs
 */
class BaseWebServiceReturnAdesao extends AbstractStructBase
{
    /**
     * The StatusServico
     ...
     * @uses BaseWebServiceReturnAdesao::setStatusServico()
     * @uses BaseWebServiceReturnAdesao::setNrLocal()
     * @uses BaseWebServiceReturnAdesao::setHoraLocal()
     * @uses BaseWebServiceReturnAdesao::setHoraCentral()
     * @uses BaseWebServiceReturnAdesao::setNrCentral()
     * @uses BaseWebServiceReturnAdesao::setRetCode()
     * @uses BaseWebServiceReturnAdesao::setTextoInformativo()
     * @uses BaseWebServiceReturnAdesao::setSeuSistema()
     * @uses BaseWebServiceReturnAdesao::setNrControleLocal()
     * @uses BaseWebServiceReturnAdesao::setSessao()
     * @uses BaseWebServiceReturnAdesao::setDesvioFluxo()
     * @uses BaseWebServiceReturnAdesao::setCtlAP()
     ...
     * @param int $statusServico
     * @return \App\Http\AreasNegocio\CAD\WSDL\StructType\BaseWebServiceReturnAdesao
     */
