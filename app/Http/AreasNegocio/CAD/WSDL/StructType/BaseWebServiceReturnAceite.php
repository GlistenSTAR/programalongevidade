 ...
 * @subpackage Structs
 */
class BaseWebServiceReturnAceite extends AbstractStructBase
{
    /**
     * The StatusServico
    ...
    public $CtlAP;
    /**
     * Constructor method for BaseWebServiceReturnAceite
     * @uses BaseWebServiceReturnAceite::setStatusServico()
     * @uses BaseWebServiceReturnAceite::setNrLocal()
     * @uses BaseWebServiceReturnAceite::setHoraLocal()
     * @uses BaseWebServiceReturnAceite::setHoraCentral()
     * @uses BaseWebServiceReturnAceite::setNrCentral()
     * @uses BaseWebServiceReturnAceite::setRetCode()
     * @uses BaseWebServiceReturnAceite::setTextoInformativo()
     * @uses BaseWebServiceReturnAceite::setSeuSistema()
     * @uses BaseWebServiceReturnAceite::setNrControleLocal()
     * @uses BaseWebServiceReturnAceite::setSessao()
     * @uses BaseWebServiceReturnAceite::setDesvioFluxo()
     * @uses BaseWebServiceReturnAceite::setCtlAP()
