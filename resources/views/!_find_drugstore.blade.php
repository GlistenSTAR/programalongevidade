...
@section('content')
  ...
  <div class="container_fluid find_drug">
    ...
    <div class="container" align="center">
      ...
      <div class="row mt-5 mb-5 content" id="desktop">
          ...
          <div class="col-md-3 col-12" align="left" style="margin-top:auto; margin-bottom:auto">
      ...
      <div class="row mt-5 mb-5 content" id="mobile">
          <div class="col-md-2 col-12" align="center">
            <img class="block" id="u603_img" alt="" width="86" height="82" data-muse-src="images/home_icone_localizar_farmacia.png?crc=4214829112" src="images/home_icone_localizar_farmacia.png?crc=4214829112" data-nsfw-filter-status="sfw" style="visibility: visible;">
          </div>
          <div class="col-md-7 form-group" style="margin-top:auto; margin-bottom:auto">
            <select class="uf col-12" name="uf" id="ufID">
              <option value="" selected>UF</option>
              @foreach ($laEstados as $estado)
              <option value="{{$estado->ESTADO_ID}}">{{$estado->ESTADO_UF}}</option>
              @endforeach
            </select>
            <select class="cidade col-12" name="cidade" id="cidadeId">
              <option value="" selected>Cidade</option>
            </select>
          ...
          <div class="col-12" align="left" style="margin-top:auto; margin-bottom:auto">
            <button class="btn btn-primary form-control form-control-lg mt-5" id="find_dragstore" style="width:100%!important;">CONSULTAR AGORA</button>
          </div>
      </div>
      <div class="mb-5">
