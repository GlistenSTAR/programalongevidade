...
@section('content')
  ...
  <div class="container_fluid product">
    ...
    <div class="container mb-5 content"> 
      ...
      <div class="row gold_border mt-5 mb-5" id="desktop">
        <div class="col-md-2 col-2" align="center"><img src="images/favicon_longevidade.jpg?crc=4006560582"></div>
        <div class="col-md-8">
          <h1>Neblock</h1>
      ...
      <div class="row gold_border mt-5 mb-5" id="mobile">
        <div class="row" style="margin-top: auto;margin-bottom: auto;">
          <div class="col-3 col-sm-3" align="right">
            <img src="images/favicon_longevidade.jpg?crc=4006560582">
          </div>
        ...
        <div class="row" style="width:95%; margin-left:auto; margin-right:auto" align="center">
          <a href="arquivos/bulas/bula_neblock.pdf" target="_blank">
            <img src="images/pdf_baixar_bulas.jpg?crc=122069707">
            <h4>BAIXAR A BULA</h4>
            <p align="center">Baixe a bula deste medicamento em PDF</p>
          </a>
        </div>
        <!-- <div class="col-2 col-md-3"><img src="images/favicon_longevidade.jpg?crc=4006560582"></div>
