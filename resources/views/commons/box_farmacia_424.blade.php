...
<div class="clearfix grpelem" id="u25594" {!! $style !!}><!-- column -->
    <!-- m_editable region-id="editable-static-tag-U22332-BP_424" template="busca_farmacias.html" data-type="image" -->

    <!-- /m_editable -->
    <!-- m_editable region-id="editable-static-tag-U22329-BP_424" template="busca_farmacias.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
    ...
    <!-- /m_editable -->
    <!-- m_editable region-id="editable-static-tag-U22326-BP_424" template="busca_farmacias.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->

    <!-- /m_editable -->
    <!-- m_editable region-id="editable-static-tag-U25295-BP_424" template="busca_farmacias.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->

    <!-- /m_editable -->
    <div class="clearfix colelem" id="pu26077"><!-- group -->
        <!-- m_editable region-id="editable-static-tag-U26077-BP_424" template="busca_farmacias.html" data-type="image" data-ice-options="clickable" data-ice-editable="link" -->

        <!-- /m_editable -->
        <!-- m_editable region-id="editable-static-tag-U26205-BP_424" template="busca_farmacias.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
