...
<div class="clearfix grpelem" id="u81884" {!! $style !!}><!-- column -->
    <!-- m_editable region-id="editable-static-tag-U81881-BP_424" template="busca_farmacias_logado.html" data-type="image" -->

    <!-- /m_editable -->
    <!-- m_editable region-id="editable-static-tag-U81912-BP_424" template="busca_farmacias_logado.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
    ...
    <!-- /m_editable -->
    <!-- m_editable region-id="editable-static-tag-U81883-BP_424" template="busca_farmacias_logado.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->

    <!-- /m_editable -->
    <!-- m_editable region-id="editable-static-tag-U81878-BP_424" template="busca_farmacias_logado.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->

    <!-- /m_editable -->
    <div class="clearfix colelem" id="pu81887"><!-- group -->
        <!-- m_editable region-id="editable-static-tag-U81887-BP_424" template="busca_farmacias_logado.html" data-type="image" data-ice-options="clickable" data-ice-editable="link" -->

        <!-- /m_editable -->
        <!-- m_editable region-id="editable-static-tag-U81899-BP_424" template="busca_farmacias_logado.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
