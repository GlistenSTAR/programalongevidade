...
<div class="clearfix grpelem" id="u25594" {!! $style !!}><!-- column -->
    <!-- m_editable region-id="editable-static-tag-U22332-BP_375" template="busca_farmacias.html" data-type="image" -->

    <!-- /m_editable -->
    <!-- m_editable region-id="editable-static-tag-U22329-BP_375" template="busca_farmacias.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
    ...
    <div class="clearfix colelem shared_content" id="u25295-6" data-muse-uid="U25295" data-muse-type="txt_frame" data-ibe-flags="txtStyleSrc" data-content-guid="u25295-6_content"><!-- content -->
        <p id="u25295-2">{{$farmacia->LGV_FARMACIA_ENDERECO_LOGRADOURO}} {{$farmacia->LGV_FARMACIA_ENDERECO}} {{$farmacia->LGV_FARMACIA_ENDERECO_NUMERO}} - {{$farmacia->LGV_FARMACIA_BAIRRO}} - {{$farmacia->LGV_FARMACIA_CIDADE}} - {{$farmacia->LGV_FARMACIA_UF}}</p>
        <p id="u25295-4">CEP {{$farmacia->LGV_FARMACIA_ENDERECO_CEP}} - {{$farmacia->LGV_FARMACIA_EMAIL}} - {{ $telefone }}</p>
    </div>
    <!-- /m_editable -->
    <!-- m_editable region-id="editable-static-tag-U22326-BP_375" template="busca_farmacias.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->

    <!-- /m_editable -->
    <!-- m_editable region-id="editable-static-tag-U25295-BP_375" template="busca_farmacias.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->

    <!-- /m_editable -->
    <div class="clearfix colelem" id="pu26077"><!-- group -->
        <!-- m_editable region-id="editable-static-tag-U26077-BP_375" template="busca_farmacias.html" data-type="image" data-ice-options="clickable" data-ice-editable="link" -->

        <!-- /m_editable -->
        <!-- m_editable region-id="editable-static-tag-U26205-BP_375" template="busca_farmacias.html" data-type="html" data-ice-options="disableImageResize,link,txtStyleTarget" -->
